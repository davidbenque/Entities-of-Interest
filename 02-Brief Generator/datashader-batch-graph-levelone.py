...
# @Last Modified time: 2018-06-15 13:24:20


# Modified version of the batch script
# processes companies that only have single connections
# these were blacklisted before as they broke the main script which looks for 2 connections out
