...
<style>
body{background-image:url("http://eoi-graphs.s3-website-eu-west-1.amazonaws.com/EARTH_RECYCLE_INC..png");background-repeat: no-repeat;background-size: contain;}
...
Graph Key
<hr>
<span class="focus">• EARTH RECYCLE INC.</span>
