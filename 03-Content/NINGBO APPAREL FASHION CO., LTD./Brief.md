...
<style>
body{background-image:url("http://eoi-graphs.s3-website-eu-west-1.amazonaws.com/NINGBO_APPAREL_FASHION_CO.,_LTD..png");background-repeat: no-repeat;background-size: contain;}
