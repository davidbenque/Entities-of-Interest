...
<style>
body{background-image:url("http://eoi-graphs.s3-website-eu-west-1.amazonaws.com/GOLDEN_OCEAN_LIMITED.png");background-repeat: no-repeat;background-size: contain;}
.markdown>p>span{background-color: white;}
</style>

# GOLDEN OCEAN LIMITED
<span>Status: Active
...
Graph Key
<hr>
<span class="focus">• GOLDEN OCEAN LIMITED</span>
