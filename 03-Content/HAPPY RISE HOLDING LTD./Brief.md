...
<style>
body{background-image:url("http://eoi-graphs.s3-website-eu-west-1.amazonaws.com/HAPPY_RISE_HOLDING_LTD..png");background-repeat: no-repeat;background-size: contain;}
